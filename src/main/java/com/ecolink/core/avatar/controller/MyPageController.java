...
public class MyPageController {
	...
	private final BookmarkPaginationService bookmarkPaginationService;
	...
	public ApiCursorPageResponse<MyPageBookmarkResponse, Long> myPageBookmarks(
		...
		@AuthenticationPrincipal UserPrincipal principal,
		Pageable pageable) {
		return ApiCursorPageResponse.ok(bookmarkPaginationService.getByStoreAndAvatar(request, pageable, principal.getAvatarId()));
	}
